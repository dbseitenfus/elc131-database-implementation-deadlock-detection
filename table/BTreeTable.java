...
public class BTreeTable extends Table {
     ...
     * @throws Exception
     */
    public BTreeTable(String folder, String name, int cacheSize) throws Exception {
...
//            LinkedDataRow rowData = tree.prototype.convertBinaryToRowData(bytes_);
    ...
    /**
     * Returns a list of rows that satisfies a primary key search condition and other arbitrary search conditions.
     * This function can return more than one row if the search uses a prefix of the primary key instead of the whole primary key
     *
     * @param pkRow the linked row whose primary key is used to define the pk search condition
